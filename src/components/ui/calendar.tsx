...
function Calendar({
  ...
  // Style classnames for the calendar
  ...
  // Custom day click handler with proper TypeScript typing
  const handleDayClick: DayClickEventHandler = (day, modifiers) => {
    if (props.mode === "single" && typeof props.onSelect === "function" && modifiers.disabled !== true) {
      props.onSelect(day);
    }
  };
